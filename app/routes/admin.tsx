...
export default function AdminPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="grid min-h-screen w-full grid-cols-1 grid-rows-[6rem_1fr] gap-4 [grid-template-areas:_'navigation'_'content'] md:grid-cols-[15rem_1fr] md:grid-rows-1 md:gap-12">
        <div className="flex h-full w-full flex-col items-center gap-2 bg-rose-200 px-8 pt-2 [grid-area:_'navigation'] md:items-start md:gap-6 md:pt-12">
          ...
          <ul className="flex flex-row gap-2 md:flex-col">
            ...
            <NavigationItem to="/admin/rsvps">RSVP's</NavigationItem>
