...
export default function AccountRoute() {
  ...
  return (
    <div className="grid min-h-screen w-full grid-cols-1 grid-rows-[4rem_1fr] gap-4 [grid-template-areas:_'navigation'_'content'] md:grid-cols-[15rem_1fr] md:grid-rows-[100%] md:gap-12">
